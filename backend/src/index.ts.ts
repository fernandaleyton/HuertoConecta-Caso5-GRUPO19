...
import vecinosRouter      from './routes/vecinos';
import parcelasRouter     from './routes/parcelas';
import siembrasRouter     from './routes/siembras';
import turnosRouter       from './routes/turnos';
import cosechasRouter     from './routes/cosechas';
import observacionesRouter from './routes/observaciones';
